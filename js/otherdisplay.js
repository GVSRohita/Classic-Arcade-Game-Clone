var instructionsObj = {
    "instructionsArray": [
        ...
        "When the player collides with the enemy bug, you have to <strong><em>forfeit 5 points</em></strong> too (of course, if score is <strong><em>0</em></strong>, this rule does not apply) in addition to <strong><em>returning to the original position</em></strong>",
